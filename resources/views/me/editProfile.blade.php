        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" enctype="multipart/form-data" action="{{ route('users.editProfile') }}">
                            @csrf
                            {{method_field('PUT')}}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="phone" type="text" class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" name="phone" value="{{ old('phone_number') ??$user->phone_number}}" >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input name="profile_photo" id="profile_photo" type="file" class="form-control{{ $errors->has('Profile Photo') ? ' is-invalid' : '' }}" name="profile_photo">
